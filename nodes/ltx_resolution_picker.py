"""
LTX Video Resolution Picker Node for ComfyUI
Resolution presets compatible with LTX-Video (divisible by 32).
"""
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "custom_width": ("INT", {"default": 1280, "min": 64, "max": 8192, "step": 32}),
                "custom_height": ("INT", {"default": 736, "min": 64, "max": 8192, "step": 32}),
            },
        }
...
NODE_CLASS_MAPPINGS = {
    "LtxResolutionPicker": LtxResolutionPicker,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "LtxResolutionPicker": "LTX Resolution Picker",
}
